...
public class TESTCASE4_ValidateSorting extends WebDriverClass{
	...
	public void main() throws InterruptedException, IOException {
		...
		String STR_NAME = getValueFromExcel("02_PAYEE", "NAME","TEST_CASE_4");
		String STR_ACCOUNT = getValueFromExcel("02_PAYEE", "ACCOUNT", "TEST_CASE_4");
		String STR_BRANCH = getValueFromExcel("02_PAYEE", "BRANCH", "TEST_CASE_4");
		String STR_ACCOUNT_NUMBER = getValueFromExcel("02_PAYEE", "ACCOUNT_NUMBER", "TEST_CASE_4");
		String STR_SUFFIX = getValueFromExcel("02_PAYEE", "SUFFIX", "TEST_CASE_4");		
		...
		//Sorting 
		payeesPage.validateAscending(this.driver, this.wait);
		payeesPage.clickNameSorter(this.driver);
		payeesPage.validateDescending(this.driver, this.wait);
	}
